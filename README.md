...
#### Team Building Book (Deprecated)
<details><summary>------- Info ---------</summary>

Moved to Rose's Utilities mod instead. 

[Steam page](https://steamcommunity.com/sharedfiles/filedetails/?id=2939004410) | [GitHub page](https://github.com/Daniel0Widing/RosesUtilities)
</details>

#### Armor Repair Kit (Deprecated)
<details><summary>------- Info ---------</summary>
